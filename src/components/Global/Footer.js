    ...
    return (
        <div className='footer'>
                        ...
                        <ul>
                            <li>
                                <div className='footer__upper__reach-us__single'>
                                    ...
                                    <a
                                        href='https://goo.gl/maps/5ebgU6yEtK1HCXzp6'
                                        target='_blank'
                                        rel='noreferrer'
                                        className='footer__upper__reach-us__links'
                                    >
                                        16-B, Lavkush Society, Behind Medlink
                                        Hospital Satellite, Ahmedabad-380015
                                    </a>
                                </div>
                            </li>
                            <li>
            ...
            <div className='footer__lower'>
                <p>
                    &#169; Copyright BooxWoox. All Rights Reserved. Proudly made
                    by BooxWoox
                </p>
            </div>
        </div>
