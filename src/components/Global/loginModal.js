...
import verticalLine from '../../assets/verticle-line.svg'
    ...
    return (
        <div>
            ...
            >
                ...
                <div
                    id={showError ? 'error-message' : 'error-message-inactive'}
                >
            ...
            >
                ...
                <div id='your-pn'>
                    ...
                    <div id='pn'>xxxxxx{pn.substr(6, 4)}</div>
                </div>
                <div id='input-otp'>
                    <input
                        id='dig1'
                ...
                <div id='tnc'>
                    By continuing, you agree to BooxWoox's Terms of Use and
                    Privacy Policy
                </div>
            </div>
            ...
            <div
                className={
                    modalLoading ? 'modal-prompt' : 'modal-prompt-inactive'
                }
            >
            ...
            <div
                className={
                    modalError ? 'modal-prompt' : 'modal-prompt-inactive'
                }
            >
                <img
                    src={x}
